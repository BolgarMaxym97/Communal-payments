...
@section('content')
    ...
    <a href="{{route('warms.create')}}" class="btn bg-olive btn-flat margin">Создать</a>
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        @foreach($warms AS $warm)
                            <tr>
                                <td>{{ $warm->created_at }}</td>
                                <td>{{ $warm->amount }}</td>
                                <td>{{ $warm->comment }}</td>
                                <td>
                                    <a href="{{route('warms.edit', ['id' => $warm->id])}}">
                                        <button type="button" class="btn btn-xs btn-primary"><i class="fa fa-pencil"
                                                                                                aria-hidden="true"></i>
                                        </button>
                                    </a>
                                    <a href="{{route('warms.delete', ['id' => $warm->id])}}">
